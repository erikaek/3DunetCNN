...
config = dict()
config["image_shape"] = (128, 128, 128) #(256, 256, 180)  # This determines what shape the images will be cropped/resampled to.
...
config["validation_split"] = 0.82  # portion of the data that will be used for training
...
def fetch_training_data_files(return_subject_ids=False):
    ...
    subject_ids = list()
    for subject_dir in glob.glob(os.path.join(os.path.dirname(__file__), "data", "preprocessed_brainstem", "*", "*")):
