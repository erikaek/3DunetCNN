...
config["distortion_factor"] = 0.25  # switch to None if you want no distortion, start with factor 0.1
config["rotation_factor"] = 0.025 # switch to None if you want no distortion, start with factor 0.01
