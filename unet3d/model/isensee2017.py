...
def isensee2017_model(input_shape=(4, 128, 128, 128), n_base_filters=16, depth=5, dropout_rate=0.3,
                      ...
                      loss_function=weighted_dice_coefficient_loss, activation_name="sigmoid",sample_weight_mode=None):
    """
    ...
    model.compile(optimizer=optimizer(lr=initial_learning_rate), loss=loss_function, sample_weight_mode=sample_weight_mode)
    return model
